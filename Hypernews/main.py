...
from Hypernews.train import train
from Hypernews.inference import inference
...
parser.add_argument('--file_directory', type=str, default='../dataset/Hypernews/one_weeks/', help='path to the files')
